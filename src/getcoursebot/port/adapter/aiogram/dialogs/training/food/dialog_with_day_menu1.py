...
class Getter:
    ...
    async def get_breakfast(
        ...
        **kwargs
        ...
        result = await service.query_recipe_with_type(TypeMeal.BREAKFAST)
    ...
    async def get_lunch(
        ...
        **kwargs
        ...
        result = await service.query_recipe_with_type(TypeMeal.LUNCH)
        dialog_manager.start_data["temporal_recipes"].append(result["class"])
        image = MediaAttachment(ContentType.PHOTO, file_id=MediaId(result["photo_id"]))
    ...
    async def get_dinner(
        ...
        **kwargs
        ...
        result = await service.query_recipe_with_type(TypeMeal.DINNER)
        dialog_manager.start_data["temporal_recipes"].append(result["class"])
        image = MediaAttachment(ContentType.PHOTO, file_id=MediaId(result["photo_id"]))
        return {
            "photo": image,
    ...
    async def get_snack(
        ...
        **kwargs
        ...
        result = await service.query_recipe_with_type(TypeMeal.SNACK)
        dialog_manager.start_data["temporal_recipes"].append(result["class"])
        image = MediaAttachment(ContentType.PHOTO, file_id=MediaId(result["photo_id"]))
        return {
            "photo": image,
